...
private:
    ...
    {
        ID_COLUMN_WIDTH = 55,
        DIRECTION_COLUMN_WIDTH = 45,
        NODE_SERVICE_COLUMN_WIDTH = 150,
        PING_COLUMN_WIDTH = 75,
        SENT_COLUMN_WIDTH = 75,
        RECEIVED_COLUMN_WIDTH = 75,
        SUBVERSION_COLUMN_WIDTH = 135, //User Agent
        SERVICES_COLUMN_WIDTH = 80,

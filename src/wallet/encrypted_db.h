...
public:
    ...
    std::unique_ptr<DatabaseBatch> MakeBatch(bool flush_on_close = true) override { return std::make_unique<EncryptedDBBatch>(std::move(m_database->MakeBatch(flush_on_close)), *this); }
};
